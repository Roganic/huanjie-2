...
当前版本已实现第二至第四阶段：可靠 AI 冒险、游戏引擎界面和故事创作闭环，并已发布到 [幻界在线版](https://huanjie-adventures.bigbiggod.chatgpt.site)。网站当前仅所有者可访问，使用 ChatGPT 登录及独立云端存档。

Phaser 主舞台承载建角、探索、战斗、输入、终章和不规则节点路网；辅助表单沿用 React。明确操作直接结算，AI 负责受限规划与对白。普通游戏使用 Qwen3.7 Plus，故事创作使用同一百炼服务的 Qwen3.8 Max。

创作工坊支持故事、地图、人物、装备物品、任务、事件、结局、补给的分类编辑，以及文本解析、草稿保存、校验、JSON 导入导出和独立试玩。已交付短篇《最后一盏渡灯》与中篇《潮汐之下的城》。真实生成短篇通过六条机制路线，并已在线导入、通关；生成内容仍需作者审阅。

在线完整原稿解析、生成稿导入通关、云端恢复已完成，完整验收见 [网站记录](docs/sessions/2026-09-09-sites-live.md) 和 [交付计划](docs/release-plan.md)。原有冒险保留自己的故事快照，不自动套用新模组。


新增默认西方奇幻美术与可替换主题：三栏角色/场景/叙事界面、素材上传预览、独立主题包和便携模组导出已实现；付费生图暂未开放。范围及限制见 [视觉平台 V1](docs/design/visual-platform-v1.md)。
